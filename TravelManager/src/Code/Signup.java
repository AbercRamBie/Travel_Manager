    ...
    public void actionPerformed(ActionEvent ae){
            ...
            if(ae.getSource() == creat){
                ...
                try{
                    ...
                    if(username.equals("")&&username.equals(null)&&name.equals("")&&name.equals(null)&&password.equals("")&&password.equals(null)&&answer.equals("")&&password.equals(null)){
                        Connect c = new Connect();

                        String query = "INSERT INTO UserDetails (UserName, Name, Password, Answer) VALUES (" + username + ", " + name + ", " + password + ", " + answer + ");";
                        ...
                        JOptionPane.showMessageDialog(null , "Problem in Creating Account.Please Retry");
                    }
